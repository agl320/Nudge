    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const newMeeting: IMeetingCreation = {
                ...
                current_activity: stateToSend.activities[0].title,
                start_time: stateToSend.start_time,
                role: stateToSend.role,
                setting: stateToSend.setting,
                activities: stateToSend.activities,
            };
