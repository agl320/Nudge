...
import { GoogleSignIn, emailAndPasswordSignUp } from "@/service/firebaseContext";
      ...
      <div className="space-y-8 mt-8">
        ...
        <div className="flex justify-center">
          <span className="block font-mono text-sm">
            ...
            <Button onClick={() => setIsOnRegister(false)} className="text-green-500 hover:text-green-400">
              Login
            </Button>
          </span>
        </div>
