...
export default function LoginForm({ setIsOnRegister }: LoginFormProps) {
  ...
  return (
    <div className="bg-white/5 border border-white/20 rounded-lg p-8 backdrop-blur-sm">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmitHandler)} className="space-y-8 mx-auto">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="User@domain.com" {...field} className="text-white/75" />
                </FormControl>
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Password" type="password" {...field} className="text-white/75" />
                </FormControl>
              </FormItem>
            )}
          />

          <Button type="submit" className="bg-green-500 text-white w-full font-mono">
            <span className="mr-2">$</span> Execute Login Protocol
          </Button>
        </form>
      </Form>
      <div className="space-y-8 mt-8">
        ...
        <div className="flex justify-center">
          <span className="block">
            <span className="text-green-400">{">"}</span> Need an account?{"\t"}
            <Button 
